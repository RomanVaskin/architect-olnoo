        ...
        <label className="mt-5 flex items-start gap-3 rounded-xl border border-border bg-surface-soft p-4 text-sm text-ink-secondary">
          ...
          <span>
            ...
            <span className="mt-1 block text-xs leading-5">
              После каждого созданного варианта система отдельным AI-запросом сравнит его с основным и доступными опорными
              ракурсами. Это может увеличить стоимость и время обработки. Результат не является профессиональным заключением.
            </span>
          </span>
        </label>
